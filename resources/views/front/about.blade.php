...
<head>
    ...
    <title>About-Daffodil Alumni Association</title>
</head>
<body>
    ...
    <div class="content-wrapper" style="margin-top: 10%">
        <div class="about-us">
            <div class="text-center">
                <div class="container">
                    <h1 class="heading-bold text-uppercase">About DIU Alumni Association (DIUAA)</h1>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row" style="margin-top: 10%">
                    <div class="services-img col-md-6 col-sm-12 col-xs-12">
                        <img class="img-responsive" src="{{ asset('/alumni') }}/images/services-img.jpg" alt="">
                    </div>
