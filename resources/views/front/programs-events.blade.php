...
<head>
    ...
    <title>Program-Daffodil Alumni Association</title>
</head>
<body>
                ...
                <div class="event-list-content">
                    ...
                    <div class="event-list-item">
                        ...
                        <div class="date-desc-wrapper">
                            <div class="date-desc">
                                <div class="date-title"><h4 class="heading-regular"><a href="{{ URL::to('/eventDetails/'.$event->idprogram_events) }}">{{ $event->title }}</a></h4></div>
                        ...
                        <div class="date-links sold-out text-center">
                            <a href="{{ URL::to('/event-register/'.$event->idprogram_events) }}" class="text-regular">REGISTER</a>
                            <span class="limit">Limited! {{ $event->vacciences }} seat left</span>
                        </div>
                    </div>
                    <?php }?>
                </div>
