                ...
                <div class="row merged">
                    ...
                    <div class="col-lg-10 col-sm-9">
                        <div class="timeline-info">
                            <ul>
                                <li class="admin-name">
                                    <h5 class="pull-right">{{ $user->name }}</h5>
                                </li>
                                <li>
                                    <a class="" href="{{ URL::to('/social/profile/'.$user->iduser) }}" title="" data-ripple="">Time line</a>
                                    <a class="" href="{{ URL::to('/social/profile/photos/'.$user->iduser) }}" title="" data-ripple="">Photos</a>
                                    {{--<a class="" href="timeline-videos.html" title="" data-ripple="">Videos</a>--}}
                                    <a class="" href="{{ URL::to('/social/friends') }}" title="" data-ripple="">Friends</a>
                                    {{--<a class="" href="timeline-groups.html" title="" data-ripple="">Groups</a>--}}
                                    <a class="" href="{{ URL::to('/social/about/'.$user->iduser) }}" title="" data-ripple="">About</a>
                                    {{--<a href="#" title="" data-ripple="">Edit</a>--}}
                                </li>
                            </ul>
                        </div>
                    </div>
