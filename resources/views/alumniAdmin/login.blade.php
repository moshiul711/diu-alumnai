...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('alumniAdmin/') }}/css/login.css" />
    <link rel="stylesheet" href="{{ asset('alumniAdmin/') }}/plugins/magic/magic.css" />
...
<div class="container">
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <form action="{{ url('/admin/login-check') }}" method="post" class="form-signin">
                {{ csrf_field() }}
                <?php
...
<script src="{{ asset('alumniAdmin/') }}/js/login.js"></script>
